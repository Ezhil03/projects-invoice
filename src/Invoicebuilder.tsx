      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
        <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <input type="text" name="name" placeholder="Client Name"
            value={client.name} onChange={handleClientChange}
            className="border p-2 rounded" />
          <input type="text" name="address" placeholder="Client Address"
            value={client.address} onChange={handleClientChange}
            className="border p-2 rounded" />
          <input type="text" name="invoiceNumber" placeholder="Invoice Number"
            value={client.invoiceNumber} onChange={handleClientChange}
            className="border p-2 rounded" />
          <input type="date" name="date" value={client.date}
            onChange={handleClientChange} className="border p-2 rounded" />
